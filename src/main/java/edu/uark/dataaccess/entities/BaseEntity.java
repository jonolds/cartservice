...
public abstract class BaseEntity<T extends BaseEntity<T>> {
	...
	private PreparedStatement buildInsertStatement(Map<String, Object> record, Connection connection)
			throws SQLException {
		LinkedList<Object> values = new LinkedList<Object>();
		StringBuilder fieldsBuilder = new StringBuilder(" ( ");
		StringBuilder insertBuilder = new StringBuilder(INSERT_PREAMBLE).append(this.repository.getPrimaryTableName());
